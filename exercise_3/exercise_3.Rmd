...
#load in data 
dengue = read.csv('/Users/jaymegerring/Downloads/GitHub/ECO395M-1/data/dengue.csv')
...
This plot shows the error curve of the Gradient Boosted Model. Along with the optimal number of trees listed as output. Let's now check the RMSE for the Gradient Boosted Trees Model. 
